...
sequenceDiagram
    ...
    Note over dao: $ npx hardhat deploy --network mumbai <br>––––––––––––<br>Deployed contracts: <br>1. SolidDaoManagement<br> 2. CTERC20TokenTemplate (deploy and initialize)<br> 3. CTTreasury<br> (5 predefined treasuries and erc20 tokens are deployed.)
    dao->>dao: Update .env
    ...
    Note over dao: $ nnpx hardhat enable-permissions --network mumbai
